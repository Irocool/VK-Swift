...
//  Weather
//
//  Created by i.kharabet on 21.02.21.
//
...
//            let tintColor = UIColor(red: 255.0 / 255.0, green: 100.0 / 255.0, blue: 20.0 / 255.0, alpha: 1.0)
            button.setTitleColor(day.isWeekend ? UIColor.normalWeekendColor : UIColor.normalColor, for: .normal)
            button.setTitleColor(UIColor.selectedColor, for: .selected)
