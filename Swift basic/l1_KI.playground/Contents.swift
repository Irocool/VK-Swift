...
print("Задание 1. Решить квадратное уравнение ax^2 + bx + c = 0")
...
let depositAmount: Double = 5000.0  // Сумма вклада в банк
